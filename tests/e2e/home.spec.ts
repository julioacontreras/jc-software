...
test('home page flow', async ({ page }) => {
	...
	await expect(page.locator('[data-testid="link-linkedin"]')).toHaveAttribute('href', 'https://www.linkedin.com/in/julio-contreras-6579b623/')
	await expect(page.locator('[data-testid="link-github"]')).toHaveAttribute('href', 'https://github.com/julioacontreras')
	await expect(page.locator('[data-testid="link-medium"]')).toHaveAttribute('href', 'https://medium.com/@julio.aranis.contreras')
});
